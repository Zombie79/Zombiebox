...
#ifdef CONFIG_AML_HDMI_TX
		if (((remote_data->repeat_release_code == 0x1c) || (remote_data->repeat_release_code == 0x4d) || (remote_data->repeat_release_code == 0x40) || (remote_data->repeat_release_code == 0x00)) &&
						(!cec_repeat)) {
